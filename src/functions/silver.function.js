...
app.http("Silver", {
    ...
    handler: async (request, context) => {
        ...
        try {
            ...
            context.error("Silver Function failed during initialization", error);
        ...
        const { silverService, logger } = dependencies;
        ...
        try {
            ...
            return await silverService.process(body, context.invocationId);
        } catch (error) {
